...
#pragma warning restore CA1825
	...
	public DynamicList<TOutput> ConvertAll<TOutput>(Converter<T, TOutput> converter)
	{
		var list = new DynamicList<TOutput>(_size);
	...
	public DynamicList<T> GetRange(int index, int count)
	{
		var list = new DynamicList<T>(count);
