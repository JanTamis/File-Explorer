...
public class TabItemViewModel : ViewModelBase
{
	...
	public IEnumerable<IPathSegment> Folders => TreeItem?
		.EnumerateToRoot()
		.Reverse()
  ...
  public int Count
	...
	public ObservableRangeCollection<IFileItem> Files { get; } = new();
		...
		if (TreeItem.IsFolder)
		{
			await Task.Run(async () =>
			{
				...
				if (recursive)
				{
					...
					{
						await Files.AddRange<Comparer<IFileItem>>(query, token: TokenSource.Token);
					}
					else
					{
